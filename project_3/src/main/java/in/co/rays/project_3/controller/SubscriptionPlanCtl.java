 ...
 *
 */
@WebServlet(urlPatterns = { "/ctl/SubscriptionPlanCtl" })
public class SubscriptionPlanCtl extends BaseCtl {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("SubscriptionPlanCtl doGet Started");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("SubscriptionPlanCtl doPost Started");
		...
		log.debug("SubscriptionPlanCtl doPost Ended");
	}
