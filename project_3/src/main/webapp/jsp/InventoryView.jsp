							...
							<div class="col-sm-12">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="quantity"
										...
										oninput="handleIntegerInput(this, 'quantityError', 25)"
										onblur="validateIntegerInput(this, 'quantityError', 25)"
										value="<%=DataUtility.getStringData(dto.getProduct()).equals("0") ? ""
					: DataUtility.getStringData(dto.getProduct())%>">

								</div>
							</div>
							<font color="red" class="pl-sm-5" id="quantityError"> <%=ServletUtility.getErrorMessage("product", request)%></font></br>
